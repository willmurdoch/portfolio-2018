...
<div class="top-player w25">
  <!--Tile iamge-->
  <a href="player.php?tea_id=<?php echo $getDet_json['awayteam']['teamid']; ?>&pl_id=<?php echo $awayAssists[0]['l_playerid']; ?>" class="thumbnail-link">
    ...
    <div class="player-details">
      <div style="color:#840017" class="player-breakdown">
        <h3><?php echo $awayAssists[0]['l_fullname']; ?></h3>
        <p>Assists: <?php echo $awayAssists[0]['timesAppeared']; ?></p>
      </div>
...
<div class="top-player w25">
  <!--Tile iamge-->
  <a href="player.php?tea_id=<?php echo $getDet_json['hometeam']['teamid']; ?>&pl_id=<?php echo $homeAssists[0]['l_playerid']; ?>" class="thumbnail-link">
    ...
    <div class="player-details">
      <div style="color:#ff7e21;" class="player-breakdown">
        <h3><?php echo $homeAssists[0]['l_fullname']; ?></h3>
        <p>Assists: <?php echo $homeAssists[0]['timesAppeared']; ?></p>
      </div>
