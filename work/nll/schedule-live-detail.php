...
<html class="no-js" lang="">
    <head>
      <title><?php echo $getDet_json['awayteam']['mascot']." vs ".$getDet_json['hometeam']['mascot']; ?>: LIVE | NLL</title>
                ...
                <div class="nll-bar sidebar-left w70">
                  <div class="matchup">
                    ...
                    <div class="matchup-split">
                      ...
                      <div class="team-wrap">
                        <div class="logo">
                          <img src="assets/logos/logo_test.png">
                        </div>
                        <div class="dets">
                    ...
                    <div class="schedule-in-progress">
                      ...
                      <!--<div class="live-score">
                        ...
                        <section class="score-home">
                          <div class="label">Colorado Mammoth</div>
                          <div class="quarter">4</div>
                          <div class="quarter">2</div>
                          <div class="quarter">3</div>
                          <div class="quarter">-</div>
                        </section>
                        <section class="score-away">
                          <div class="label">New England Blackwolves</div>
                          <div class="quarter">1</div>
                      ...
                      <a href="#" class="btn gold play">Live Stream</a>
                    </div>
