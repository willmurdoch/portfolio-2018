...
$allJsonPlayers=$pl_json['scoringleaders']['player'];
            ...
            <div class="scaler">
              <div class="content-wrap">
                <div class="nll-bar sidebar-left w70">
                  ...
                  <!--Players-->
                  <div class="stats-all">
                    <h4>TOP PLAYERS: OFFENSE</h4> | <a href="stat-detail.php">See All Stats <span>›</span></a>
                  </div>
                  <div class="stat-listing">
                    <?php
                      for($i=0;$i<sizeof($allJsonPlayers);$i+=3){
                        include 'components/stat-block-player.php';
                      }
                    ?>
                  </div>
                </div>
